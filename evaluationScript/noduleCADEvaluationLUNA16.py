...
def collect(annotations_filename,annotations_excluded_filename,seriesuids_filename):
    ...
    seriesUIDs_csv = seriesuids_filename
...
def noduleCADEvaluation(annotations_filename,annotations_excluded_filename,seriesuids_files,results_filename,outputDir):
    '''
    ...
    (allNodules, seriesUIDs) = collect(annotations_filename, annotations_excluded_filename, seriesuids_files)    
